...
export default function GradientBlinds({
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      if (firstResizeRef.current) {
        ...
        mouseTargetRef.current = [gl.drawingBufferWidth / 2, gl.drawingBufferHeight / 2]
      }
    }
    resize()
  ...
  return <div ref={containerRef} className={`gradient-blinds-container ${className}`} style={mixBlendMode ? { mixBlendMode } : undefined} />
}
