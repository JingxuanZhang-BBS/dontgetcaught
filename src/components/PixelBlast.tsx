...
export default function PixelBlast({
  ...
  }, [variant, pixelSize, color, antialias, patternScale, patternDensity, pixelSizeJitter, enableRipples, rippleIntensityScale, rippleThickness, rippleSpeed, transparent, edgeFade])
